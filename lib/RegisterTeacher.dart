...
class RegisterTeacherState extends State<RegisterTeacher> {
  ...
  startUpload() {
    ...
    if(tmpFile == null || firstName.isEmpty || lastName.isEmpty || teacherId.isEmpty || password.isEmpty || username.isEmpty){
      ...
      uploadData(fileName,firstName,lastName,teacherId, username ,password);
    }
  }
  ...
  uploadData (String fileName, String firstName, String lastName, String teacherId, String username, String password) async {
